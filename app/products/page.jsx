...
// Header bar for the products page: fixed black nav (logo, nav links, cart/heart/profile icons, lang toggle)
// floating over a banner image. Width fix: nav itself needs inset-x-0 since "fixed" ignores parent width.
  ...
  return (
    <header className="w-full bg-yellow-50/10 border-b border-gray-200  flex items-center ">
      ...
      <div className="max-w-[1440px] bg-red-500 mx-auto">
        ...
        <nav className=" py-8  bg-black rounded-b-2xl text-white justify-around z-999 fixed inset-x-0 max-w-7xl mx-auto flex items-center gap-8">
...
// Pagination matching the reference design (@SCR-20260618-msaz.png):
// pill Previous/Next buttons on the ends, page numbers in the middle with current page highlighted.
...
// Mock product list — UI only, no backend wired up yet.
const mockProducts = [
  {
    id: 1,
    name: "Product",
...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* max-w-7xl mx-auto: keeps the whole "All Product" section (sidebar + grid) centered with consistent side margins */}
      <div className="max-w-7xl mx-auto px-6 py-8 flex gap-8">
        {/* Filters sidebar — mt-140 pushes it below the fixed navbar + banner image */}
            ...
            {mockProducts.map((product) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <button className="w-full flex items-center justify-center gap-2 bg-black text-white py-2 rounded-xl text-sm hover:bg-gray-800 transition-colors">
