      ...
      <div className="flex-1 min-w-0 max-w-3xl pr-0 xl:pr-12">
        ...
        <div className="mb-12 pt-4" id="creator-faq">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Q: ยอดเงินส่วนแบ่งจะได้รับอย่างไรและเมื่อไหร่?</h3>
              <p className="text-[15px] leading-7 text-slate-600">
                A: เมื่อสินค้าถูกจัดส่งสำเร็จ ยอดส่วนแบ่งรายได้ (20% ของราคาขาย) จะถูกประมวลผลและแสดงผลทันทีที่หน้าประวัติรายได้ในเมนูโปรไฟล์ของคุณ โดยทางผู้ดูแลระบบจะสรุปยอดและดำเนินการโอนส่วนแบ่งให้ตามข้อมูลติดต่อ/ธนาคารที่ระบุไว้
              </p>
            </div>
          </div>
        </div>
